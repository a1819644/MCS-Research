...
if __name__ == '__main__':
	...
	pkt_trig[OSPF_LSUpd].lsalist[victim_lsa_index][OSPF_Router_LSA].adrouter = "10.0.6.6"
	...
	pkt_trig[OSPF_LSUpd].lsalist[victim_lsa_index][OSPF_Router_LSA].linklist[2].metric = 1
